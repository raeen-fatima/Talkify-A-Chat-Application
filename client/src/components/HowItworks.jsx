        ...
        <div className="grid gap-8 md:grid-cols-4">
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="relative bg-white/60 backdrop-blur-xl border border-gray-200 rounded-2xl p-6 flex flex-col items-center text-center shadow-md hover:shadow-xl transition-all cursor-pointer group"
