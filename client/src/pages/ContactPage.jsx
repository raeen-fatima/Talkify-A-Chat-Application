    ...
    <div className="bg-gradient-to-br from-[#f1f8e9] via-[#fffde7] to-[#e3f2fd] min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 pb-16">
        {[
          ...
          <motion.div
            key={index}
            className="p-6 bg-white/70 backdrop-blur-md border border-gray-200 rounded-xl shadow-lg text-center hover:scale-105 hover:shadow-2xl transition-all duration-300"
            initial={{ opacity: 0, y: 20 }}
      ...
      <section className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 pb-20">
        {/* Form */}
        <motion.div
          className="bg-white/80 backdrop-blur-lg border border-gray-200 rounded-xl shadow-lg p-8 space-y-6"
